...
(function(global, factory) {
  ...
  var validateEventDispatches = void 0;
  {
    validateEventDispatches = function(event) {
      ...
      !(instancesIsArr === listenersIsArr && instancesLen === listenersLen)
        ? warning_1(false, 'EventPluginUtils: Invalid `event`.')
        : void 0;
    };
  }
  ...
  var skipSelectionChangeEvent =
    ExecutionEnvironment_1.canUseDOM && 'documentMode' in document && document.documentMode <= 11;
  ...
  */
  ...
  var ReactFiberLegacyContext = function(stack) {
    ...
    function pushContextProvider(workInProgress) {
      ...
      var memoizedMergedChildContext =
        (instance && instance.__reactInternalMemoizedMergedChildContext) || emptyObject_1;
  ...
  var ReactFiberScheduler = function(config) {
    ...
    function dispatch(sourceFiber, value, expirationTime) {
      !(!isWorking || isCommitting)
        ? invariant_1(false, 'dispatch: Cannot dispatch during the render phase.')
        : void 0;
  ...
  function getHostProps$3(element, props) {
    ...
    !(props.dangerouslySetInnerHTML == null)
      ? invariant_1(false, '`dangerouslySetInnerHTML` does not make sense on <textarea>.')
      : void 0;
  ...
  function assertValidProps(tag, props, getStack) {
    ...
    if (props.dangerouslySetInnerHTML != null) {
      !(props.children == null)
        ? invariant_1(false, 'Can only set one of `children` or `props.dangerouslySetInnerHTML`.')
        : void 0;
      !(
  ...
  ReactBatch.prototype.render = function(children) {
    !this._defer
      ? invariant_1(false, 'batch.render: Cannot render a batch that already committed.')
      : void 0;
  ...
  var ReactDOM = {
    ...
    unmountComponentAtNode: function(container) {
      !isValidContainer(container)
        ? invariant_1(false, 'unmountComponentAtNode(...): Target container is not a DOM element.')
        : void 0;
